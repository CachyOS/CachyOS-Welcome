...
removed-db-lock = A trava de banco de dados do Pacman foi removida!
lock-doesnt-exist = O db.lock do Pacman não existe!
...
reset-btn-tooltip = Reseta suas mudanças atuais
update-system-app-btn-tooltip = Aplicar suas mudanças para o sistema
...
dns-server-failed = Erro mudando o servidor DNS!
...
# Tweaks page (fixes)
remove-lock-title = Remover Trava de banco de dados Pacman (db lock)
...
remove-orphans-title = Remover Órfãos
...
button-software-label = Softwares do CachyOS
