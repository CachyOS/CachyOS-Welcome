...
desktop-on-handheld-warning = Você está tentando instalar a edição Desktop em um dispositivo portátil. Por favor, use a edição Handheld para suporte adequado neste hardware
