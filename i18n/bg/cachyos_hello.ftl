...
desktop-on-handheld-warning = Опитвате се да инсталирате настолната версия на преносимо устройство. Моля, използвайте версията Handheld за правилна поддръжка на този хардуер
