...
desktop-on-handheld-warning = Az asztali kiadást próbálod telepíteni egy kézi eszközre. Kérjük, használd a Handheld kiadást a megfelelő támogatáshoz ezen a hardveren
