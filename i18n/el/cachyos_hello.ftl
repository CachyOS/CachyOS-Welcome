...
apply = Εφαρμογή
reset = Επαναφορά
enable-dot = Ενεργοποίηση DNS μέσω TLS (DoT)
...
enable-doh = Ενεργοποίηση DNS μέσω HTTPS (DoH)
doh-tooltip = Κρυπτογράφηση αιτημάτων DNS με χρήση HTTPS, μέσω του τοπικού διακομιστή μεσολάβησης blocky (απαιτεί υποστήριξη από την πλευρά του διακομιστή, εγκαθιστά το blocky)
doh-blocky-install-failed = Αποτυχία εγκατάστασης του blocky για υποστήριξη DoH!
...
custom-dns-ipv4 = Διευθύνσεις IPv4 (διαχωρισμός με κόμματα):
custom-dns-ipv6 = Διευθύνσεις IPv6 (διαχωρισμός με κόμματα):
...
dns-check-hint = Αφού κάνετε εφαρμογή, επαληθεύστε τον πάροχο DNS σας στο
