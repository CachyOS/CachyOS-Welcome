...
desktop-on-handheld-warning = Вы пытаетесь установить редакцию Desktop на портативном устройстве. Пожалуйста, используйте редакцию Handheld для надлежащей поддержки на этом оборудовании
